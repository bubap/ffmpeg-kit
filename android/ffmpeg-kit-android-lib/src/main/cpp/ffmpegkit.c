...
JNIEXPORT jint JNICALL Java_com_arthenica_ffmpegkit_FFmpegKitConfig_nativeFFmpegExecute(JNIEnv *env, jclass object, jlong id, jobjectArray stringArray) {
    ...
    jfieldID fid = (*env)->GetStaticFieldID(env, configCls, "mMC264Encoder", "Lcom/arthenica/ffmpegkit/MC264Encoder;");
...
JNIEXPORT void JNICALL Java_com_arthenica_ffmpegkit_MC264Encoder_onH264MediaCodecEncodedFrame(JNIEnv *env, jobject obj, jobject data, jint size, jlong presentationTimeUs, jint b_keyframe)
{
